...
//             return res.status(400).json({
//                 success: false,
//                 message: "New Password and Confirm Password value does not match, Please Try Again."
//             });
//         }
...
//             res.status(401).json({
//                 success: false,
//                 message: "Failure in changing the Password."
//             })
//         }

//         // Send Mail 
//         try {
//             const mailResponse = await mailSender(email, "Password Update Email from StudyNotion", "Your Password is changed Successfully");
...
//         return res.status(500).json({
//             success: false,
//             message: "Failure in changing the password, Please Try again."
//         })
//     }
