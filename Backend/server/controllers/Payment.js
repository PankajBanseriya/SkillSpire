...
const { courseEnrollmentEmail } = require('../mail/templates/courseEnrolllmentEmail');
...
exports.capturePayment = async (req, res) => {
    try {
        ...
        if (course.studentEnrolled.includes(uid)) {
            return res.status(400).json({
                success: false,
                message: "Student os already enrolled.",
            });
        }
        ...
        try {
            ...
            return res.status(400).json({
                success: false,
                message: "Failure in initiate order.",
                error: error.message,
            })
        }
    ...
    if (signature === digest) {
        ...
        try {
            ...
            const emailResponse = await mailSender(
                ...
                "Congratulations, you are onborded into new course"
            );
