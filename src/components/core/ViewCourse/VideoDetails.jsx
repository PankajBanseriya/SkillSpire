        ...
        <div style={{ position: "relative", paddingTop: "56.25%" }}>
          ...
          {videoEnded && (
            <div
              ...
              className="absolute inset-0 z-[100] grid h-full place-content-center font-inter gap-y-4"
            >
              ...
              <IconBtn
                ...
                children={<MdOutlineReplay size={25}/>}
              />
              ...
              <div className="mt-5 flex min-w-[250px] justify-center gap-x-4 text-xl">
                {!isFirstVideo() && (
                  <button
                    ...
                    className="blackButton flex items-center gap-x-1"
                  >
                    <MdSkipPrevious/>
                    Prev
                  </button>
